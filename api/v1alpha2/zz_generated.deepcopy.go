...
func (in *ImageUpdateAutomationSpec) DeepCopyInto(out *ImageUpdateAutomationSpec) {
	*out = *in
	...
	if in.PolicyNamespaceSelector != nil {
		in, out := &in.PolicyNamespaceSelector, &out.PolicyNamespaceSelector
		*out = new(PolicyNamespaceSelector)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PolicyNamespaceSelector) DeepCopyInto(out *PolicyNamespaceSelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PolicyNamespaceSelector.
func (in *PolicyNamespaceSelector) DeepCopy() *PolicyNamespaceSelector {
	if in == nil {
		return nil
	}
	out := new(PolicyNamespaceSelector)
